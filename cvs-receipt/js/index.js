...
percentCoupon = () => {
  ...
  let coupon = {
    ...
    couponValue: `'Up to $99.00 Value'`,
    couponCode: randomMinMax(10000, 90000),
...
fixedCoupon = () => {
  ...
  let product = getProduct();
  let couponValue = (parseFloat(product.price) * 0.75).toFixed(2);

  console.log("FIXED COUPON RED MACHINE", couponValue);
};

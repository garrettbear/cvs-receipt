...
percentCoupon = () => {
  // common percent deals seen are 5,10,15,20,25,50 percent off (will not make random)
  const percentOptions = [5, 10, 15, 20, 25, 50];
  let randomPercent = percentOptions[getRandomInt(percentOptions.length)];
  let product = getProduct();
  let couponValue = '$5';
  // console.log(`You get ${randomPercent}% off ${product.productTitle}`);
  let percentCoupon = {
    id: couponID,
    discount:`${randomPercent}% off`,
    discountDescription:`Get ${randomPercent}% off ${product.productTitle}`,
    couponValue: `'Up to ${couponValue} Value'`,
    couponCode: 13136,
    barcode: 900909903333121298,
  };
  console.log('Percent', percentCoupon);
};

fixedCoupon = () => {
  //max discount is 75% off
  // productPrice x .75 = discountTakenOff
  // i.e. $10 product get random number between 0.01  and 7.5 ...
  // so a user will get $7.50 off an item which would be 75% off
  //round up to first decimal i.e. $6.66 would be $6.70
  console.log("FIXED");
};
...
const rawProductData = [
  ...
  [
    ...
    {
      productTitle:
        "M&M'S Coffee Nut Peanut Chocolate Candy Sharing Size, 9.6 OZ",
      price: "$4.19"
    },
    {
      productTitle:
  ...
  [
    ...
    {
      productTitle:
        "California Charcoal Activated Charcoal Peel-Off Mask, 2.8 OZ",
      price: "$19.99"
    },
    {
    ...
    {
      productTitle:
        "Dove Almonds With Cinnamon and Dark Chocolate Candy, 5.5 OZ",
      price: "$4.89"
    },
    {
      productTitle:
  ...
  [
    ...
    {
      productTitle:
        "Crest Pro-Health Advanced Toothpaste 3.5 OZ, Deep Clean Mint",
      price: "$2.99"
    },
    {
  ...
  [
    ...
    {
      productTitle:
        "Schwarzkopf Got 2b Phenomenal Light Hold Styling Gel, 6 OZ",
      price: "$8.29"
    },
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Caladrox Ointment Skin Protectant & Itch Relief",
      price: "$4.99"
    },
    {
    ...
    {
      productTitle:
        "Nexium 24HR, 20 mg, Heartburn Relief Tablets, Acid Reducer",
      price: "$10.99"
    },
    {
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Nicotine Transdermal System Patches, Step 1, 21mg",
      price: "$39.99"
    },
    {
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Glucosamine Chondroitin Triple Strength Caplets",
      price: "$39.49"
    },
    {
      productTitle: "CVS Health Antiseptic Skin Cleanser",
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Fluticasone Nasal Spray 60 Metered Sprays, 50 mcg",
      price: "$12.99"
    },
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Extra Strength Pain Relief 500 mg Caplets, 100 CT",
      price: "$7.99"
    },
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Men's Multivitamin & Multimineral Tablets, 120CT",
      price: "$9.99"
    },
    {
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Guards For Men Maximum Absorbency One Size, 52CT",
      price: "$12.49"
    },
    {
      productTitle:
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Non-Medicated Nasal Inhaler, Lavender Scent 1 EA",
      price: "$4.99"
    },
    {
  ...
  [
    ...
    {
      productTitle:
        "CVS Health Immune Support Vitamin C Fizzy Drink 1000mg, 36CT",
      price: "$10.99"
    },
    {
      productTitle:
